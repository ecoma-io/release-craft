...
export const MANIFEST: readonly ManifestRow[] = [
  ...
  // — A-git —
  {
    ...
    transports: ["CLI"],
    classes: ["exit codes", "envelope bytes", "outcome kinds and envelope shapes", "tag mints"],
    expectedFiles: ["expected/git-01.json"],
    provenance: [
      "phase 14 §3.3",
  ...
  },
  {
    ...
    expectedFiles: ["expected/git-02.json"],
  ...
  },
  {
    ...
    provenance: [
      ...
      "seating note: W1's own second run — the second process's document observes rung 1 (the ladder's second rung, phase 10 §3.2), the fresh process inherits only the durable register's recorded lease",
    ],
    status: "live",
  },
  {
  ...
  },
  {
    ...
    transports: ["CLI"],
    classes: ["exit codes", "envelope bytes"],
    expectedFiles: ["expected/git-12.json"],
    provenance: [
      "phase 14 §3.3",
