...
### Phase 9 extension — 17 adapter scenarios

The 17 Remote (R) scenarios above are the Phase 9 adapter's coverage,
...
suite (`test/adapters/github/reconciliation.test.ts`).
